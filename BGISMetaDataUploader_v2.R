...
# # Set Username and Read in Credentials File
my_username <- "anthony.covarrubias"
my_creds<-read.csv(paste0("C:/Users/",my_username, "/Documents/Creds2.csv"),stringsAsFactors=FALSE)
Sys.setenv("entouch_api_key"=as.character(my_creds$entouch_api_key))
Sys.setenv("my_user"=my_username)
...
# V2: ENTOUCH API data pulls within this script
